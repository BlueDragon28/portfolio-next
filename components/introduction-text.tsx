export default function IntroductionText(
  ...
  return (
    <div className={className}>
      ...
      <p className="my-3 text-justify">
        J&apos;ai réalisé de nombreux projets dans de nombreux domaines (programmation, réseaux, machines virtuelles...), je possède donc une connaissance approfondie sur un certain nombre de sujets et sais m&apos;adapter rapidement à de nouveaux environnements.
      </p>
    </div>
  );
}
